...
insert  into `login`(`login_id`,`user_code`,`password`,`is_use`,`change_pd_time`,`login_num`,`login_time`,`author_id`,`delete`) values (3,10001,'c42e1e2e06144c57ee5035a48e9b1a43',0,'0000-00-00 00:00:00',0,'0000-00-00 00:00:00',2,1);
...
insert  into `logs`(`id`,`type`,`user_id`,`msg`,`data`,`time`,`delete`) values (1,'test',1,'测试','无','2018-11-22 16:45:46',0),(2,'test1',2,'测试2','删除日志','2018-11-22 16:52:51',0);
